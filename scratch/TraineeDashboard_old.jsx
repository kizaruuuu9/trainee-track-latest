...
// ΓöÇΓöÇΓöÇ TIME AGO HELPER ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
// ΓöÇΓöÇΓöÇ TOP NAVIGATION BAR (LinkedIn-style) ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
// ΓöÇΓöÇΓöÇ LAYOUT WRAPPER ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
// ΓöÇΓöÇΓöÇ LEFT PROFILE CARD (LinkedIn-style) ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
// ΓöÇΓöÇΓöÇ RIGHT SIDEBAR WIDGET ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
// ΓöÇΓöÇΓöÇ PROGRESS BAR HELPER ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
// ΓöÇΓöÇΓöÇ PAGE 1: DASHBOARD HOME (LinkedIn Feed-style) ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
// ΓöÇΓöÇΓöÇ PAGE 2: PROFILE ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
export const TraineeProfileContent = ({ viewedProfileId = null, onBack = null }) => {
    ...
    // ΓöÇΓöÇΓöÇ Photo upload handler ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
    ...
    // ΓöÇΓöÇΓöÇ Banner upload handler ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
    ...
    // ΓöÇΓöÇΓöÇ Dynamic Arrays Handlers ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
            ...
            <div className="ln-card ln-profile-header-card">
                ...
                <div className="ln-profile-header-body">
                    ...
                    <div className="ln-profile-header-info">
                            ...
                            <div>
                                ...
                                {headerLocationParts.length > 0 && (
                                    <p className="ln-profile-header-loc">
                                        {showHeaderAddress && trainee?.address && <MapPin size={14} />} {headerLocationParts.join(' ΓÇó ')}
                                    </p>
                                )}
                        ...
                        {/* Resume section ΓÇö bottom right */}
                                    ...
                                    return (
                                        <div key={f.key} className="ln-info-item">
                                            ...
                                            {editing ? (
                                                ...
                                                <div className="ln-info-value">{trainee?.[f.key] || 'ΓÇö'}</div>
                                            )}
                            ...
                            {(editing ? trainingForm.trainingStatus === 'Graduated' : trainee?.trainingStatus === 'Graduated') && (
                                <div className="ln-info-item">
                                    ...
                                    {editing ? (
                                        ...
                                        <div className="ln-info-value">{trainee?.graduationYear || 'ΓÇö'}</div>
                                    )}
                                </div>
                            )}
                        </div>
                            ...
                            {(editing ? empForm.employmentStatus === 'Employed' : trainee?.employmentStatus === 'Employed') && (
                                <>
                                    <div className="ln-info-item">
                                        ...
                                        {editing ? <input type="text" required className="form-input" value={empForm.employer} onChange={e => setEmpForm({ ...empForm, employer: e.target.value })} placeholder="Company name" /> : <div className="ln-info-value">{trainee?.employer || 'ΓÇö'}</div>}
                                    </div>
                                    <div className="ln-info-item">
                                        <label className="ln-info-label">Job Title{editing && <span style={{ color: '#cc1016', marginLeft: 4 }}>*</span>}</label>
                                        {editing ? <input type="text" required className="form-input" value={empForm.jobTitle} onChange={e => setEmpForm({ ...empForm, jobTitle: e.target.value })} placeholder="Your position" /> : <div className="ln-info-value">{trainee?.jobTitle || 'ΓÇö'}</div>}
                                    </div>
                                    <div className="ln-info-item">
                                        <label className="ln-info-label">Date Hired{editing && <span style={{ color: '#cc1016', marginLeft: 4 }}>*</span>}</label>
                                        {editing ? <input type="date" required className="form-input" value={empForm.dateHired} onChange={e => setEmpForm({ ...empForm, dateHired: e.target.value })} /> : <div className="ln-info-value">{trainee?.dateHired || 'ΓÇö'}</div>}
                                    </div>
                                </>
                            )}
                        </div>
                                ...
                                <div className="ln-info-grid" style={{ gap: 12 }}>
                                    <div className="ln-info-item" style={{ gridColumn: '1 / -1' }}>
                                        ...
                                        {editing ? (
                                            ...
                                            <div className="ln-info-value">{edu.school || 'ΓÇö'}</div>
                                        )}
                                    </div>
                                    <div className="ln-info-item" style={{ gridColumn: '1 / -1' }}>
                                        ...
                                        {editing ? (
                                            ...
                                            <div className="ln-info-value">{edu.degree || 'ΓÇö'}</div>
                                        )}
                                    </div>
                                    <div className="ln-info-item">
                                        ...
                                        {editing ? (
                                            ...
                                            <div className="ln-info-value">{edu.from || 'ΓÇö'}</div>
                                        )}
                                    </div>
                                    <div className="ln-info-item">
                                        ...
                                        {editing ? (
                                            ...
                                            <div className="ln-info-value">{edu.to || 'ΓÇö'}</div>
                                        )}
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="ln-info-grid" style={{ gap: 12 }}>
                                    <div className="ln-info-item" style={{ gridColumn: '1 / -1' }}>
                                        ...
                                        {editing ? (
                                            ...
                                            <div className="ln-info-value">{work.company || 'ΓÇö'}</div>
                                        )}
                                    </div>
                                    <div className="ln-info-item" style={{ gridColumn: '1 / -1' }}>
                                        ...
                                        {editing ? (
                                            ...
                                            <div className="ln-info-value">{work.position || 'ΓÇö'}</div>
                                        )}
                                    </div>
                                    <div className="ln-info-item">
                                        ...
                                        {editing ? (
                                            ...
                                            <div className="ln-info-value">{work.from || 'ΓÇö'}</div>
                                        )}
                                    </div>
                                    <div className="ln-info-item">
                                        ...
                                        {editing ? (
                                            ...
                                            <div className="ln-info-value">{work.to || 'ΓÇö'}</div>
                                        )}
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="ln-info-grid" style={{ gap: 12 }}>
                                    <div className="ln-info-item" style={{ gridColumn: '1 / -1' }}>
                                        ...
                                        {editing ? (
                                            ...
                                            <div className="ln-info-value">{cert.name || 'ΓÇö'}</div>
                                        )}
                                    </div>
                                    <div className="ln-info-item" style={{ gridColumn: '1 / -1' }}>
                                        ...
                                        {editing ? (
                                            ...
                                            <div className="ln-info-value">{cert.org || 'ΓÇö'}</div>
                                        )}
                                    </div>
                                    <div className="ln-info-item">
                                        ...
                                        {editing ? (
                                            ...
                                            <div className="ln-info-value">{cert.issue || 'ΓÇö'}</div>
                                        )}
                                    </div>
                                    <div className="ln-info-item">
                                        ...
                                        {editing ? (
                                            ...
                                            <div className="ln-info-value">{cert.noExp ? 'Does not expire' : (cert.exp || 'ΓÇö')}</div>
                                        )}
                                    </div>
                                    <div className="ln-info-item" style={{ gridColumn: '1 / -1' }}>
                                        ...
                                        {editing ? (
                                            ...
                                            <div className="ln-info-value">{cert.credId || 'ΓÇö'}</div>
                                        )}
                                    </div>
                                    <div className="ln-info-item" style={{ gridColumn: '1 / -1' }}>
                                        ...
                                        {editing ? (
                                            ...
                                            <div className="ln-info-value">ΓÇö</div>
                                        )}
                                    </div>
                                </div>
                            </div>
...
// ΓöÇΓöÇΓöÇ PAGE 4: OPPORTUNITIES ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
const Opportunities = () => {
...
// ΓöÇΓöÇΓöÇ PAGE 5: MY APPLICATIONS ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
                                ...
                                <tr key={a.rowKey || a.id}>
                                    ...
                                    <td>
                                        <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                                            ...
                                            <button
                                                ...
                                                disabled={!(a.partner?.id || a.job?.partnerId)}
                                            >
                                                {a.partner?.companyName || a.job?.companyName || 'ΓÇö'}
                                            </button>
                                        </div>
                                    </td>
                                    <td style={{ fontWeight: 600, color: '#0a66c2' }}>{a.job?.title || 'Direct Contact'}</td>
                                    <td style={{ color: 'rgba(0,0,0,0.5)', fontSize: 13 }}>{a.eventDate || 'ΓÇö'}</td>
                                    ...
                                    <td>
                                        <div style={{ display: 'flex', gap: 6, flexWrap: 'wrap' }}>
                                            ...
                                            {!a.outgoingMessage && !a.incomingMessage && <span style={{ fontSize: 12.5, color: 'rgba(0,0,0,0.45)' }}>ΓÇö</span>}
                                        </div>
                                    </td>
                                    <td>
                                        {(a.outgoingMessage || a.incomingMessage) ? (
                                            ...
                                            <span style={{ fontSize: 12.5, color: 'rgba(0,0,0,0.45)' }}>ΓÇö</span>
                                        )}
                                    </td>
                                    <td>
                                        {a.attachmentUrl ? (
...
// ΓöÇΓöÇΓöÇ MAIN TRAINEE DASHBOARD ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
